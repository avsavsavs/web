  ...
  },
  {
    ...
    answer: (
      <>
        ...
        bloXroute, Blocknative, Flashbots, rsync builder, Titan builder, ETH builder, 
        payload and Beaver Build.
      </>
    ),
  },
  {
    ...
    answer: (
      <>
        Yes! if you want your transactions to be completely private, and you don´t
        care about the refund, you need to connect to the following 
        endpoint: <b>https://rpc.mevblocker.io/norefunds</b> as the url
        instead.
        <br />
        <br />
        This endpoint focuses on privacy for users that want to perform transactions 
        and it will not share TX data over WS. It prevents transactions failures (same as /noreverts).
        <br />
        <br />
  ...
  },
  {
    ...
    answer: (
      <>
        ...
        <br />
        <br />
        Goal of RPC is to prevent 99% of sandwiches but no existing solution can provide full 100% protection. 
        Due to reorgs/forked blocks 0.1% of transactions might become publicly available before on-chain confirmation.
      </>
    ),
  },
  {
